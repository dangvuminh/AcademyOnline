        ...
        return <div className="modal-body">
            ...
            <form onSubmit={submitHandle2}>
                <div className="form-group">
                    ...
                    <label>Current First name: <b>{student.student_firstname}</b></label>
                ...
                <div className="form-group">
                    ...
                    <label >Current Last Name: <b>{student.student_lastname}</b></label>
                ...
                <div className="form-group">
                    ...
                    <label >Current Email: <b>{student.email}</b></label>
